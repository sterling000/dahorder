...
module.exports.validate = async (event, context) => {
  ...
  if (typeof decodedJwt.phone !== "undefined") {
    const arn = `arn:aws:execute-api:${process.env.REGION}:222008606357:*/${process.env.STAGE}/*/*`; // example: "arn:aws:execute-api:ap-southeast-1:495xxxxxxx:46xxxxxxx/dev/*/api/v1/*"
