<template>
    <div class="image-uploader">
        <label for="thumbnail" id="thumbnailLabel"><p class="thumbnail">Image</p>
            <div class="wrapper">
...
export default {
    ...
    methods: {
        thumbnailChanged: function(e){
            ...
            mpImg.render(this.imagePreview, { maxWidth: 340, maxHeight: 180 }, this.renderCallback);
        },
        renderCallback: function(){
            this.imagePreview.toBlob((blob) => {
                this.thumbnail = blob;
        ...
        uploadImage: function(presignedURL) {
            ...
            axios.put(presignedURL, this.thumbnail, options)
            .then((res) => {
